...
<div class="row">
  <div class="col-md-6">
    <form action="/update/<?= $cabang["cabang_id"] ?>" method="post">
      <?= csrf_field(); ?>
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Nama Cabang</label>
        <input value="<?= old('nama_cabang', $cabang['nama_cabang']) ?>" autofocus autocomplete="off" type="text" name="nama_cabang" class="form-control <?php if (session()->getFlashdata('error')) echo "is-invalid" ?>" id="exampleFormControlInput1">
